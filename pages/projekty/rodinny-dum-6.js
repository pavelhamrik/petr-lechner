            ...
            <Layout title={`Rodinný dům 6 | ${SITE_TITLE} • ${SITE_SUBTITLE}`}>
                <Grid className={sections['main-section']} align='stretch'>
                    ...
                    <GridItem width='medium-11 large-10 huge-9' offset='medium-1 large-2'>
                        <Image
                            src='/static/photos/large/rodinny-dum-6-8735.jpg'
                            alt='[img]'
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-6-8730.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-6-8733.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-6-8746.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-6-8749.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-6-8758.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-6-8761.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-6-8762.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-6-8767.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-6-8768.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-6-8770.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-6-8777.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-6-8779.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                ...
                <NextPageBar>
                    <Heading level={2}>Rodinný dům 7</Heading>
                    <p>
                        <Button href='/projekty/rodinny-dum-7'>Další projekt &rarr;</Button>
                    </p>
                </NextPageBar>
            </Layout>
        )

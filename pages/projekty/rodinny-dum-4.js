            ...
            <Layout title={`Rodinný dům 4 | ${SITE_TITLE} • ${SITE_SUBTITLE}`}>
                <Grid className={sections['main-section']} align='stretch'>
                    ...
                    <GridItem width='medium-11 large-10 huge-9' offset='medium-1 large-2'>
                        <Image
                            src='/static/photos/large/rodinny-dum-4-8665.jpg'
                            alt='[img]'
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-4-8640.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-4-8643.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-4-8648.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-4-8649.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-4-8651.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-4-8652.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-4-8655.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-4-8666.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                    ...
                    <GridItem width='small-6 medium-3'>
                        <Image
                            src='/static/photos/small/rodinny-dum-4-8670.jpg'
                            alt='[img]'
                            lightbox={true}
                        />
                    </GridItem>
                ...
                <NextPageBar>
                    <Heading level={2}>Rodinný dům 5</Heading>
                    <p>
                        <Button href='/projekty/rodinny-dum-5'>Další projekt &rarr;</Button>
                    </p>
                </NextPageBar>
            </Layout>
        )
